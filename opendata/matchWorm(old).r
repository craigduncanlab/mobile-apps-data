...
# This works with version 1 of Junior Cricket Scorer
# Prep : https://thenewstack.io/r-package-drawing-layered-plots-with-ggplot2/
##################
# GATHER THE DATA
##################
...
#first innings lines
g1<-g +
# move colour inside axes to build a legend automatically, use 'scale' to adjust labels for the legend
